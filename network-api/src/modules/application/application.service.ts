...
export class ApplicationService {
  ...
  async saveApplication(applicationInfoDto: ApplicationInfoDto): Promise<Application> {
    const newApplication = this.applicationRepository.create(applicationInfoDto);
    return await this.applicationRepository.save(newApplication);
  }
}